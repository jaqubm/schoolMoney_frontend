...
const BalancesPage = () => {
  ...
  const sanitizedFileName = sanitizeFileName(
      `transaction_history_${userData?.name || "user"}`
  );
      ...
      <div className="flex flex-col w-screen h-screen">
        ...
        <div className="flex w-full h-full overflow-hidden">
          ...
          <div className="flex flex-col w-full h-full pl-[59px] pt-[19px]">
            ...
            {/* Transaction history */}
            <div className="flex justify-between items-center mb-4 pr-[59px]">
              <h3 className="text-gray-500 text-sm">Transaction History</h3>
              {transactions && transactions.length > 0 && (
                  <PDFDownloadLink
                      document={<TransactionReport transactions={sortedTransactions} />}
